    ...
    <div className="relative min-h-screen flex flex-col">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <main className="flex-1">
            ...
            <div className="container px-4 md:px-6 mx-auto">
              <div className="flex flex-col items-center space-y-4 text-center">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-wider sm:text-4xl md:text-5xl lg:text-6xl/none text-white">
                    Hello World YAYYY
                  </h1>
                  <p className="py-5 mx-auto max-w-[700px] text-gray-300 md:text-xl">
          ...
          <section ref={secondLayerRef} className="w-full py-12 md:py-24 lg:py-32 bg-white">
            <div className="container px-4 md:px-6 mx-auto">
