  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 space-y-16">
        <section>
          <h1 className="text-white text-6xl font-thin tracking-tight">Beat Bowl</h1>
        ...
        <section className="space-y-7">
          <div className="h-fit flex justify-center" style={{ aspectRatio: 30/17, maxHeight: "80vh" }}>
        ...
        <section className="space-y-7">
          <div className="h-fit flex justify-center" style={{ aspectRatio: 30/26, maxHeight: "80vh" }}>
            <VideoPlayer videoId={test.videoId} />
          </div>
        </section>

        <section>
          <h2 className="text-3xl font-light text-white mb-3">User Experience</h2>
          <p className="text-white/70 leading-relaxed">
